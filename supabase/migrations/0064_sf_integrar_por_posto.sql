-- =============================================================
-- sf_integrar ganha p_posto: grava sf_registros com o posto de
-- Integração REAL (não 'Integração' fixo), pré-requisito pra
-- Integração ser um posto dirigido por perfil. Assinatura muda
-- → DROP antes do replace.
-- =============================================================
...
begin
  ...
  -- registros posto=p_posto: 1 do produto + 1 por placa (alimenta o gate do Lançamento)

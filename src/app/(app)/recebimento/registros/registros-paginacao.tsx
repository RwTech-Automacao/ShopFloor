...
import { TAMANHOS_PAGINA } from '@/modules/recebimento/domain/registros-filtros'
      ...
      <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
        <span>
          ...
          {!umaPaginaSo && (
            <>
              {' '}
              · página <span className="font-medium text-foreground">{pagina + 1}</span> de {totalPaginas}
            </>
          )}
        </span>
        ...
        {/* Exporta com os MESMOS filtros da tela: a rota lê os mesmos parâmetros da URL. */}
